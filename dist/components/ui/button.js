...
function Button(_a) {
    var { className, variant = "default", size = "default", asChild = false, children } = _a, props = __rest(_a, ["className", "variant", "size", "asChild", "children"]);
    return (_jsx(ButtonPrimitive, Object.assign({ "data-slot": "button", className: cn(buttonVariants({ variant, size, className })), render: asChild ? children : undefined }, props, { children: asChild ? null : children })));
}
